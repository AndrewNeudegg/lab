...
func defaultAgentTools() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"ResearchAgent": allow("internet.search", "memory.propose_write"),
		"ReviewerAgent": allow("internet.search", "repo.read", "repo.search", "repo.current_diff", "git.diff", "git.status", "go.test", "go.build", "test.run", "bun.check", "bun.build"),
