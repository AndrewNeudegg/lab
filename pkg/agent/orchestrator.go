...
func defaultDelegationInstruction(t taskstore.Task) string {
	return strings.Join([]string{
		...
		"When a diagram would clarify machine flow, state transitions, architecture, or handoff context, include a concise Mermaid fenced block. Use the homelabd brand palette from docs/diagramming-and-brand-colours.md: light accent #2563eb on #ffffff/#f5f7fb with text #172033; dark accent #60a5fa on #172033/#0b1120 with text #dbe7f6. Do not invent custom diagram colours.",
...
func (o *Orchestrator) uxPrompt(t taskstore.Task) string {
	return strings.Join([]string{
		...
		"- Use concise Mermaid diagrams when they clarify user journeys, state transitions, interaction models, machine flows, architecture, or handoffs. Diagrams must use the homelabd brand palette from docs/diagramming-and-brand-colours.md: light accent #2563eb on #ffffff/#f5f7fb with text #172033; dark accent #60a5fa on #172033/#0b1120 with text #dbe7f6.",
		"Rules:",
		"- Use repo.list/repo.search/repo.read with the workspace argument before editing.",
