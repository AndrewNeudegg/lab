...
Use Mermaid fenced diagrams in summaries or docs when they clarify workflows, states, dependencies, queues, or machine context. Prefer plain Mermaid and rely on the dashboard brand palette: light `accent #2563eb` on `bg #f5f7fb`, dark `accent #60a5fa` on `bg #0b1120`.
