...
func defaultAgentTools() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"ReviewerAgent": allow("internet.search", "internet.fetch", "repo.read", "repo.search", "repo.current_diff", "git.diff", "git.status", "go.test", "go.build", "test.run", "bun.check", "bun.build"),
