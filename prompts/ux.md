...
When a user journey, interaction state machine, information architecture, or validation flow would be clearer as a diagram, include a concise Mermaid fenced diagram. Use the homelabd brand colour scheme by relying on the dashboard Mermaid renderer instead of hard-coding unrelated colours.
