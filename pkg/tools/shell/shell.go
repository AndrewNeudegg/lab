...
func (LimitedTool) Description() string { return "Run an allowlisted command without shell expansion." }
...
func (ApprovedTool) Description() string { return "Run an approved command without shell expansion." }
