...
func defaultAgentTools() map[string]map[string]bool {
	return map[string]map[string]bool{
		"OrchestratorAgent": allow(
			...
			"chat.history", "chat.search", "chat.send",
			...
			"go.test", "go.build", "bun.check", "bun.build", "bun.test", "bun.uat.tasks", "bun.uat.site",
		...
		"CoderAgent": allow(
			...
			"git.status", "git.diff", "git.branch", "git.describe", "git.log", "git.show",
			"go.fmt", "go.test", "go.build", "test.run", "bun.check", "bun.build", "bun.test", "bun.uat.tasks", "bun.uat.site",
			"shell.run_limited",
		),
		"UXAgent": allow(
			"text.correct", "text.summarize",
		...
		"ReviewerAgent": allow("text.correct", "text.summarize", "internet.search", "internet.fetch", "internet.research", "repo.read", "repo.search", "repo.current_diff", "git.diff", "git.status", "git.branch", "git.describe", "git.log", "git.show", "git.merge_check", "go.test", "go.build", "test.run", "bun.check", "bun.build", "bun.test", "bun.uat.tasks", "bun.uat.site"),
