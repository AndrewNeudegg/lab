...
- `/assistant`: proactive Assistant runs, signal inbox, capability routes, recommendation decisions, returned receipts, evidence snapshots, and a compact link to Assistant capability documentation.
