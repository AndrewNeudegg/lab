...
func defaultAgentTools() map[string]map[string]bool {
	return map[string]map[string]bool{
		...
		"ResearchAgent": allow("text.correct", "internet.search", "internet.fetch", "internet.research", "memory.propose_write"),
		"ReviewerAgent": allow("text.correct", "internet.search", "internet.fetch", "internet.research", "repo.read", "repo.search", "repo.current_diff", "git.diff", "git.status", "git.branch", "git.describe", "git.log", "git.show", "git.merge_check", "go.test", "go.build", "test.run", "bun.check", "bun.build"),
